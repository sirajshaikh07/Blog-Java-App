			...
			<div class="row justify-content-center">
				<div class="col-md-6">
					<div class="card">
						...
						<div class="card-body ">
							<form class="mb-4" action="../RegisterUser" method="post">
								<div class="mb-3">
								...
								<div class="mb-3">
									<label for="exampleInputPassword" class="form-label">Gender:</label>
										Male:<input type="checkbox" class=""
										value="male" name="gender">
										
										Female:<input type="checkbox" class="mr-2"
										value="female" name="gender">
										Other:<input type="checkbox" class="mr-2"
										value="other" name="gender">
										
								</div>
								<div class="mb-3">
									<label for="exampleTextarea" class="form-label">Additional
										Information</label>
